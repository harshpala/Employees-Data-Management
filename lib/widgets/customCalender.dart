...
///    [CustomCalender] and provides an optional compact view where the
...
class _CustomCalenderState extends State<CustomCalender> {
  ...
  @override
  void didUpdateWidget(CustomCalender oldWidget) {
  ...
  Widget _buildPicker(Widget Month) {
    switch (_mode) {
...
class _DayPickerState extends State<_DayPicker> {
  ...
  List<Widget> _dayHeaders(
    ...
    for (int i = localizations.firstDayOfWeekIndex; true; i = (i + 1) % 7) {
      ...
      if (i == 0) {
        ...
        weekday = ''; // Default value if out of range
      }
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle dayStyle = textTheme.caption!.apply(
      fontWeightDelta: 1,
      fontSizeDelta: 1.5,
    );
    final Color enabledDayColor = colorScheme.onSurface.withOpacity(0.70);
    final Color disabledDayColor = colorScheme.onSurface.withOpacity(0.38);
    final Color selectedDayColor =
        widget.isNoDate ? colorScheme.primary : colorScheme.onPrimary;
    final Color selectedDayBackground =
        widget.isNoDate ? Colors.transparent : colorScheme.primary;
...
/// [CustomCalender], or [showDatePicker] which create full date pickers.
///
/// See also:
///
///  * [CustomCalender], which provides a Material Design date picker
///    interface.
///
